% chktex-file 1 chktex-file 9 chktex-file 26 chktex-file 18
% Settings used by fontspec
% Enable additional font features (such as fancy ligatures)
\defaultfontfeatures+{
    Script=Latin,
    Language=Default,
    % Common, Contextual, Rare, Historic, TeX
